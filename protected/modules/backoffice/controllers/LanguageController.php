...
class LanguageController extends Controller
{
    ...
    public function accessRules()
    {
        return array(
            array('allow',
                'actions' => array('index'),
                'roles' => array('Backoffice.Language.View'),
            ),
            array('allow',
                'actions' => array('create'),
                'roles' => array('Backoffice.Language.Create'),
            ),
            array('allow',
                'actions' => array('update'),
                'roles' => array('Backoffice.Language.Update'),
            ),
            array('allow',
                'actions' => array('delete'),
                'roles' => array('Backoffice.Language.Delete'),
            ),
            array('deny',
                'users' => array('*'),
            ),
