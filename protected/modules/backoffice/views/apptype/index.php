...
<?php $this->widget('application.widgets.ModalView', array(
    ...
    'visible' => Yii::app()->user->checkAccess('Backoffice.ApplicationType.Create'),
...
<div class="the-box no-border">
    <div class="row">
        <div class="col-sm-8 btn-toolbar" role="toolbar">
            <?php if (Yii::app()->user->checkAccess('Backoffice.ApplicationType.Create')) : ?>
            <div class="btn-group">
                <?php echo CHtml::link('<i class="fa fa-plus"></i> Create', '#', array(
                    'class' => 'btn btn-success',
                    'data-toggle' => 'modal',
                    'data-target' => '#create-app-type',
                )); ?>
            </div>
            <?php endif; ?>
        </div>
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'buttons' => array(
                    'update' => array(
                        'visible' => 'Yii::app()->user->checkAccess("Backoffice.ApplicationType.Update")',
                    ),
                    'delete' => array(
                        'visible' => 'Yii::app()->user->checkAccess("Backoffice.ApplicationType.Delete")',
                    ),
                ),
            ),
        ),
